...
! function() {
    ...
    window.tram = function(t) {
        ...
        if (M.transition) {
            var L = M.timing.dom;
            if (A.style[L] = h["ease-in-back"][0], !A.style[L])
        ...
        var D = e.frame = function() {
            ...
            C = f(I, function(e) {
                function n(e, n) {
                    var i = t.data(e, m) || t.data(e, m, new I.Bare);
            ...
            P = f(B, function(t, e) {
                ...
                t.init = function() {
                    e.init.apply(this, arguments), this.current || (this.current = {}, J.perspective && W.perspective && (this.current.perspective = W.perspective, Y(this.el, this.name, this.style(this.current)), this.redraw()))
                }, t.set = function(t) {
            ...
            X = f(function(e) {
                ...
                function a() {
                    ...
                    if (i)
                        for (D(a), e = R(), t = i; t--;)(n = d[t]) && n.render(e)
                }
        ...
        M.transform && (Q.transform = [P], J = {
            ...
            skewX: [k],
            skewY: [k]
        }), M.transform && M.backface && (J.z = [_, "translateZ"], J.rotateZ = [k], J.scaleZ = [b], J.perspective = [x]);
        var V = /ms/,
            K = /s|\./;
        return t.tram = e
    }(window.jQuery);
    var e = {},
        ...
        r = t(function(t) {
            ...
            function l() {
                $ && ($.reject(), m.off("load", $.resolve)), $ = new v.Deferred, m.on("load", $.resolve)
            }
            var f = {},
                h = {},
                d = [],
            ...
            f.resize = s(m, z), f.scroll = s(m, "scroll.webflow resize.webflow orientationchange.webflow load.webflow"), f.redraw = s(), f.location = function(t) {
                window.location = t
            ...
            f.load = function(t) {
                ...
                t = t || {}, _ = !0, m.triggerHandler("__wf_destroy"), null != t.domready && (x = t.domready), b.each(h, o), f.resize.off(), f.scroll.off(), f.redraw.off(), d = [], p = [], "pending" === $.state() && l()
        ...
        a = (t(function(t) {
            ...
            e.define("forms", t.exports = function(t, n) {
                ...
                function r(e, n) {
                    ...
                    r.handler = null, r.redirect = i.attr("data-redirect"), O.test(s) ? r.handler = f : s || (v ? r.handler = l : j())
                }
    ...
    t(function(t) {
        ...
        e.define("ix", t.exports = function(t, i) {
            ...
            function o() {
                var i = t("[data-ix]");
                i.length && (i.each(u), i.each(a), j.length && (e.scroll.on(c), setTimeout(c, 1)), A.length && e.load(l), z.length && setTimeout(f, $), n.init(), e.redraw.up())
            }
                ...
                if (c) {
                    ...
                    l && (g.style(a, c.style), i.each(l, function(t) {
                        ...
                        if ("load" !== u) {
                            ...
                            if ("hover" === u) return a.on("mouseenter" + b, i), a.on("mouseleave" + b, r), void(E = E.add(a));
                            if ("scroll" !== u) {
                                var l = q[u];
                                if (l) {
                                    var f = a.closest(l);
                        ...
                        } else t.preload && !_ ? A.push(i) : z.push(i)
                    }))
                }
            }
            ...
            return g.init = function(t) {
                ...
                v = !1, $ = 100, setTimeout(function() {
                    r(window.__wf_ix)
                }, 1)
            }, g.design = function() {
                v = !0, g.destroy()
            }, g.destroy = function() {
                m = !0, E.each(u), e.scroll.off(c), n.async(), j = [], A = [], z = []
            }, g.ready = function() {
        ...
        function e(t, e, n, i) {
            function r(t, e) {
                return O = k(t) ? t : [t], y || r.build(), O.length > 1 && (y.items = y.empty, O.forEach(function(t) {
                    var e = g("thumbnail"),
                        n = g("item").append(e);
                ...
                }), y.strip.empty().append(y.items), p(y.content, "group")), _(v(y.lightbox, "hide").focus()).add("opacity .3s").start({
                    opacity: 1
            ...
            r.build = function() {
                ...
                if (t !== b) {
                    ...
                    return b = t, x.show(), c(e.html && w(e.width, e.height) || e.url, function(r) {
                        function o() {
                            x.hide(), t === b ? (m(y.arrowLeft, "inactive", t <= 0), m(y.arrowRight, "inactive", t >= O.length - 1), y.view ? (_(y.view).add("opacity .3s").start({
                                opacity: 0
                            }).then(l(y.view)), _(f).add("opacity .3s").add("transform .3s").set({
                                x: t > i ? "80px" : "-80px"
                            }).start({
                                opacity: 1,
                                x: 0
                ...
                return _(y.lightbox).add("opacity .3s").start({
                    opacity: 0
                }).then(u), r
            }, r.prev = function() {
                b > 0 && r.show(b - 1)
        ...
        n.define("lightbox", t.exports = function(t) {
            ...
            return c.ready = c.design = c.preview = function() {
                s = l && n.env("design"), f.destroy(), u = {}, (a = h.find(d)).webflowLightBox()
            }, jQuery.fn.extend({
                webflowLightBox: function() {
                    ...
                    t.each(e, function(e, n) {
                        ...
                        o || (o = t.data(n, d, {
                            ...
                            images: [],
                            embed: ""
                        })), o.el.off(d), i(o), s ? o.el.on("setting" + d, i.bind(null, o)) : o.el.on("tap" + d, r(o)).on("click" + d, function(t) {
                            t.preventDefault()
                        })
                    })
                }
...
Webflow.require('ix').init([{
    ...
    "value": {
        ...
        "triggers": [{
            ...
            "stepsA": [{
                ...
                "opacity": 1,
                "transition": "transform 150ms ease 0ms, opacity 150ms ease-out 0ms",
                "scaleX": 1,
                "scaleY": 1,
                "scaleZ": 1
            }],
            "stepsB": [{
                "opacity": 0,
                "transition": "transform 100ms ease 0ms, opacity 100ms ease-out 0ms",
                "scaleX": 0.5,
                "scaleY": 0.5,
                "scaleZ": 1
            }]
            ...
            "stepsA": [{
                ...
                "opacity": 1,
                "transition": "transform 200ms ease-out 0ms, opacity 200ms ease-out 0ms",
                "x": "0px",
                "y": "0px"
            }],
            "stepsB": [{
    ...
    "slug": "move-nav-contact",
    "name": "move nav contact",
    "value": {
        "style": {},
        "triggers": [{
            "type": "scroll",
    ...
    "value": {
        ...
        "triggers": [{
            ...
            "loopA": true,
            "stepsA": [{
                "transition": "transform 20000ms ease 0ms",
                "x": "5px",
                "y": "25px",
                "rotateX": "0deg",
                "rotateY": "0deg",
